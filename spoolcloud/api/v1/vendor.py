...
from spoolcloud.api.v1.models import Message, Vendor, VendorEvent
...
async def get(
    ...
    db_item = await vendor.get_by_id(db, vendor_id, current_user.id)
...
async def delete(
    ...
    await vendor.delete(db, vendor_id, current_user.id)
