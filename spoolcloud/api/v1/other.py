...
from spoolcloud.database import filament, spool
...
async def find_materials(
    *,
    ...
    return await filament.find_materials(db=db, user_id=current_user.id)
...
async def find_article_numbers(
    *,
    ...
    return await filament.find_article_numbers(db=db, user_id=current_user.id)
...
async def find_lot_numbers(
    *,
    ...
    return await spool.find_lot_numbers(db=db, user_id=current_user.id)
...
async def find_locations(
    *,
    ...
    return await spool.find_locations(db=db, user_id=current_user.id)
...
async def rename_location(
    ...
    *,
    ...
    await spool.rename_location(db=db, user_id=current_user.id, current_name=location, new_name=body.name)
    return body.name
